...
export default function EditorEvento() {
  ...
  useEffect(() => {
    if (!loading) {
      const cumpleañosData = eventos.find((e) => e.evento === "cumpleaños");
      if (cumpleañosData) {
        const selected = selectedDays[0];
        setPrecioDia(cumpleañosData.preciosPorDia[selected] || "");
        setPrecioConBuffet(cumpleañosData.precioconbuffet || "");
      }
    }
